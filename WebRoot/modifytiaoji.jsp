            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="header">修改调剂信息</div>
                            <div class="content">
                                 <% String id = request.getParameter("id"); %> 
                                <form class="form-horizontal" method=post action="ModifyTiaoji?id=<%= id %>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                         <% String direct = request.getParameter("direct"); %>
                                             <input   name="direct" value="<%=direct %>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    	 <label class="col-md-3 control-label">学习方式</label>
                                        <div class="col-md-6">
                                             <select name="studyway" class="selectpicker"    >
