            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="header">添加学校信息</div>
                            <div class="content">
                                <form class="form-horizontal" method=post action="AddSchool">
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">学校名称</label>
                                        <div class="col-md-6">
                                            <input  name="schoolname" placeholder="学校名称" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">地区</label>
                                        <div class="col-md-6">
                                            <input name="area"  placeholder="地区" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <select name="character" class="selectpicker" data-title="院校特性"  >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input name="belong"   placeholder="隶属" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group text-center">
                                        ...
                                        <div class="col-md-6">
                                            <button type="submit" class="btn btn-fill btn-info " > 确认添加 </button>
                                        </div>
                                    </div>
                                </form>
                            </div>
