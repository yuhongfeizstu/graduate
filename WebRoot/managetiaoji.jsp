                        ...
                        <div class="card">
                            ...
                            <div class="toolbar">
                                  	<button class="btn btn-primary btn-fill btn-wd" style="margin:0px 20px 0px 20px;"> 
                                  		<a href="addtiaoji.jsp" style="color: #F9F9F9;" >添加调剂信息 </a>
                                  	</button>
                            </div>
                            ...
                            <table id="bootstrap-table" class="table">
                                ...
                                <thead>
                                	...
                                	<th data-field="salary" data-sortable="true">专业</th>
                                	<th data-field="country" data-sortable="true">研究方向</th>
                                	<th data-field="city">学习方式</th>
                                	<th  >操作</th>
                                </thead>
                                <tbody>
                                <c:forEach var="t" items="${tiaojilist}">
                                       <tr>
                                        	<td>${t.id }</td>
                                        	<td>${t.schoolname}</td>
                                        	<td>${t.major}</td>
                                    	    <td>${t.direct}</td>
                                        	<td>${t.studyway }</td>
                                        	<td><a href="modifytiaoji.jsp?id=${t.id }&schoolname=${t.schoolname}&major=${t.major}&direct=${t.direct}&studyway=${t.studyway }">修改</a>
                                        	<a href="DeleteTiaoji?id=${t.id }" style="margin:20px;">删除</a></td>
