                        ...
                        <div class="card">
                            ...
                            <div class="toolbar">
                                  	<button class="btn btn-primary btn-fill btn-wd" style="margin:0px 20px 0px 20px;">
                                  		<a href="addteacher.jsp"  style="color: #F9F9F9;">添加导师信息 </a>
                                  	</button>
                            </div>
                            ...
                            <table id="bootstrap-table" class="table">
                                ...
                                <thead>
                                	...
                                	<th data-field="salary" data-sortable="true">学校</th>
                                	<th data-field="country" data-sortable="true">专业</th>
                                ...
                                <c:forEach var="teacher" items="${teacherlist}">
                                  <tr>
                                    	...
                                    	<td>${teacher.major}</td>
                                    	<td>${teacher.email}</td>
                                    	<td><a href="modifyteacher.jsp?id=${teacher.id}&teaname=${teacher.teaname}&schoolname=${teacher.schoolname}&major=${teacher.major}&email=${teacher.email}">修改</a>
                                    	<a href="DeleteTeacher?id=${teacher.id}" style="margin:20px;">删除</a></td>
                                   ...
                                   <!--  <tr>
                                    	...
                                    	<td><a href="modifyteacher.html">修改</a><a href="shouye.html" style="margin:20px;">删除</a></td>
                                    </tr>
                                    <tr>
                                       <td>2</td>
                                    	<td>李四</td>
