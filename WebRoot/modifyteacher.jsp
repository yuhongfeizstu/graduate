            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="header">修改导师信息</div>
                            <div class="content">
                                 <% String id = request.getParameter("id"); %> 
                                <form class="form-horizontal" method=post action="ModifyTeacher?id=<%=id%>">
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">导师姓名</label>
                                        <div class="col-md-6">
                                            <% String teaname = request.getParameter("teaname"); %> 
                                            <input  name="teaname" value="<%=teaname%>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <% String major = request.getParameter("major"); %> 
                                             <input name="major"  value="<%=major%>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group text-center">
                                        ...
                                        <div class="col-md-6">
                                            <button type="submit" class="btn btn-fill btn-info " >
                                            	<!-- <a href="manageteacher.html"  style="color: #F9F9F9;">确认修改</a> -->
                                            	确认修改
                                            </button>
                                        </div>
                                    </div>
