                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="toolbar">
                                  	<button class="btn btn-primary btn-fill btn-wd" style="margin:0px 20px 0px 20px;">
                                  		<a href="addschool.jsp" style="color: #F9F9F9;" >添加学校信息 </a>
                                  	</button>
                            </div>
                            ...
                            <table id="bootstrap-table" class="table">
                                ...
                                <thead>
                                	...
                                	<th data-field="name" data-sortable="true">学校</th>
                                	<th data-field="salary" data-sortable="true">地区</th>
                                	<th data-field="country" data-sortable="true">特性</th>
                                	<th data-field="city">院校隶属</th>
                                	<th  >操作</th>
                                </thead>
                                <tbody>
                                ...
                                <c:forEach var="school" items="${schoollist}" > 
                                    <tr>
                                        <td></td>
                                    	<td name="id">${school.id}</td>
                                    	<td name="schoolname">${school.schoolname}</td>
                                    	<td name="area">${school.area}</td>
                                    	<td name="character">${school.character}</td>
                                    	<td name="belong">${school.belong}</td>
                                    	<td name="id"><a href="modifyschool.jsp?id=${school.id}&schoolname=${school.schoolname}&area=${school.area}&character=${school.character}&belong=${school.belong}">修改</a>
                                    	               <a href="DeleteSchool?id=${school.id}" style="margin:20px;">删除</a></td>
                                    </tr>                    
                                </c:forEach>   
                                    ...
                                    <!-- <tr>
                                    	...
                                    	<td>985</td>
                                    	<td>教育部</td>
                                    	<td><a href="modifyschool.html">修改</a><a href="shouye.html" style="margin:20px;">删除</a></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    	<td>2</td>
                                    ...
                                    <tr>
                                    	...
                                    	<td>985</td>
                                    	<td>教育部</td>
                                    	<td><a href="shouye.html">修改</a><a href="shouye.html" style="margin:20px;">删除</a></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    	<td>4</td>
