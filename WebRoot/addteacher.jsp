            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="header">添加导师信息</div>
                            <div class="content">
                                <form class="form-horizontal" method=post action="AddTeacher">
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">导师姓名</label>
                                        <div class="col-md-6">
                                            <input  name="teaname" placeholder="姓名" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">所属院校</label>
                                        <div class="col-md-6">
                                            <input  name="schoolname" placeholder="学校" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                             <input name="major"  placeholder="专业" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">联系方式</label>
                                        <div class="col-md-6">
                                            <input  name="email" type="email" placeholder="邮箱" class="form-control">
                                        </div>
                                    </div>
