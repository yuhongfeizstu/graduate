            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="header">添加调剂信息</div>
                            <div class="content">
                                <form class="form-horizontal" method="post" action="AddTiaoji">
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">学校</label>
                                        <div class="col-md-6">
                                            <input  name="schoolname" placeholder="招生单位" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">专业</label>
                                        <div class="col-md-6">
                                            <input   name="major" placeholder="招生专业" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                             <input  name="direct" placeholder="研究方向" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    	 <label class="col-md-3 control-label">学习方式</label>
                                        <div class="col-md-6">
                                             <select name="studyway" class="selectpicker" data-title="学习方式"  >
